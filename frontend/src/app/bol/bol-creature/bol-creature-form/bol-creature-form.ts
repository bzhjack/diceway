...
import {BolHerosTrait} from '../../bol-heros/bol-hero-form/bol-hero-trait/bol-hero-trait';
import {Popover, PopoverModule} from 'primeng/popover';
import {FloatLabel} from 'primeng/floatlabel';
import {AutoFocus} from 'primeng/autofocus';
import {BolCreatureStateService} from '../../bol-services/bol-creature-state.service';
import {BolCreatureCapaciteModel, BolCreatureTailleModel} from '../../bol-models/bol-creature.model';
import {Picture} from '../../../shared/picture/picture';


@Component({
    selector: 'bol-creature-form',
  imports: [
    FormsModule,
    ReactiveFormsModule,
    SelectModule,
    ...
    templateUrl: './bol-creature-form.html',
    styleUrl: './bol-creature-form.scss'
})
export class BolCreatureForm implements OnDestroy {
  ...
  constructor(private ref: DynamicDialogRef, protected config: DynamicDialogConfig) {
  ...
  picture() {
    const ref = this.ds.open(Picture, {header: 'Photo de la créature'});
  ...
  addCapacite(panel: Popover, event: any) {
    panel.toggle(event);
    const capacite = this.fb.group({
