...
import {BolHerosModel, BolHerosOrigines} from "../bol-models/bol-heros.model";
import {BolRegionModel} from "../bol-models/bol-region.model";
...
import {BolHerosCarriereModel} from "../bol-models/bol-carriere.model";
import {BolArmureModel, BolHerosArmureModel} from "../bol-models/bol-armure.model";
...
export class BolHerosService {
  ...
  quickCreate(pnj: BolHerosModel): Observable<any> {
    return this.http.post<BolHerosModel>(`${environment.apiBase}/api/bol/pnj/create`, <BolHerosModel>pnj);
  }

  quickUpdate(pnj: BolHerosModel): Observable<any> {
    return this.http.post<BolHerosModel>(`${environment.apiBase}/api/bol/pnj/update`, <BolHerosModel>pnj);
  }
