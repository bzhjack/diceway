...
@Component({
  ...
  imports: [
    ...
    templateUrl: './bol-pnj-form.html',
    styleUrl: './bol-pnj-form.scss'
})
export class BolPnjForm {
  readonly panelPnj = viewChild<Popover>('opPnj');
  ...
  picture() {
    const ref = this.ds.open(Picture, {header: 'Photo du pnj'});
