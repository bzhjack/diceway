...
return new class extends Migration
{
    ...
    {
        Schema::create('bol_fight_session_pnj', function (Blueprint $table) {
            $table->id();
            $table->uuid('fight_session_id');
            $table->uuid('pnj_id')->nullable();
            $table->string('camp');
    ...
    {
        Schema::dropIfExists('bol_fight_session_pnj');
    }
};
