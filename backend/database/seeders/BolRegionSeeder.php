...
class BolRegionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // carrieres_requises : carrières obligatoires (array d’IDs, cast 'array' sur le modèle)
        // carrieres_interdites : carrières interdites (array d’IDs, cast 'array' sur le modèle)
        $regions = [
            ...
            ["id" => 4, "region" => "Îles du Crâne", "langue_native_id" => 1, "carrieres_requises" => [13]],
            ...
            ["id" => 13, "region" => "Plaines de Klaar", "langue_native_id" => 4, "premiere_carriere_id" => 3, "carrieres_interdites" => [1, 14, 22, 24]],
            ["id" => 14, "region" => "Satarla"],
            ["id" => 15, "region" => "Shamballah", "langue_native_id" => 11],
            ["id" => 16, "region" => "Terres Désolées"],
            ["id" => 17, "region" => "Tyrus"],
            ["id" => 18, "region" => "Urceb"],
            ["id" => 19, "region" => "Valgard", "langue_native_id" => 13, "carrieres_requises" => [3]],
            ["id" => 20, "region" => "Zalut"],
        ];
