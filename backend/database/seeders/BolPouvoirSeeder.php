...
class BolPouvoirSeeder extends Seeder
{
    ...
    {
        $pouvoirs = [
            ['id' => 1, 'pouvoir' => 'Armes améliorées', 'description' => 'Dé de bonus à toutes les attaques (griffes, crocs, lames, bec, queue, etc.).'],
            ['id' => 2, 'pouvoir' => 'Armure', 'description' => 'Protection d6-2 (2).'],
            ['id' => 3, 'pouvoir' => 'Attaques dévastatrices', 'description' => 'Les dégâts passent à la catégorie de taille supérieure.'],
            ...
            ['id' => 8, 'pouvoir' => 'Intangible', 'description' => 'Pas de corps physique dans cette dimension ; blessé uniquement par sorcellerie ou alchimie.'],
            ['id' => 9, 'pouvoir' => 'Poison', 'description' => 'Contact paralysant ; jet de vigueur Difficile (−2) pour éviter la paralysie. Paralysé = mort dans l\'heure sauf nouveau jet Difficile (−2) réussi.'],
            ...
            ['id' => 11, 'pouvoir' => 'Régénération', 'description' => 'Récupère 1 PV par round ; se débarrasse des effets d\'un coup précis au bout de 2 rounds.'],
            ['id' => 12, 'pouvoir' => 'Savoir spécial', 'description' => 'Possède une carrière au rang 6.'],
            ['id' => 13, 'pouvoir' => 'Séducteur', 'description' => 'Peut asservir 1d6+6 piétaille. Un héros résiste via un jet d\'esprit.'],
            ...
            ['id' => 16, 'pouvoir' => 'Vulnérabilité', 'description' => 'Ajoute un pouvoir supplémentaire mais donne une faiblesse : un élément inflige le double des dégâts (magie, feu, électricité, fer, acide...), ou un élément inoffensif pour les humains devient dommageable (lumière du jour, eau, musique, symboles...).'],
        ];
