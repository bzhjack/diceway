...
import {EntityFormLabels} from './entity-form-page.base';

/**
 * Socle commun des pages de formulaire d'entité migrées vers Signal Forms
 * (créature, démon — héros/PNJ restent sur {@link BolEntityFormPageBase} tant qu'ils
 * n'ont pas été portés). Même cycle de vie que le socle Reactive Forms : chargement par
 * paramètre de route, sauvegarde, navigation retour, garde "modifications non
 * enregistrées", raccourci Ctrl+S et sélection d'avatar.
 */
export abstract class BolSignalEntityFormPageBase<TEntity, TFormModel extends {avatar: string | null}>
