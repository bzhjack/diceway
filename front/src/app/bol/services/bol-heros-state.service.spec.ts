...
function hero(overrides: {
  ...
  return {
    ...
    active: false,
    type: 'H',
    combat: {initiative: 0, initiative_effective: 0, melee: 0, tir: 0, defense: 0, defense_effective: 0},
    attributs: {vigueur: overrides.vigueur ?? 0, agilite: 0, agilite_effective: 0, esprit: 0, aura: 0},
